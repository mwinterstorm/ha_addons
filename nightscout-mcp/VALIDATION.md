...
Local Node.js 22.23.2 and 26.8.1 tests pass with real HTTP servers, the official MCP client and
...
are exact and lockfile-controlled. Docker was not running on the development Mac,
so image build and container/HAOS runtime are unverified. Live Nightscout, actual
